...
View = (function() {
  function View(context) {
    this.context = context;
    this.$el = $(`<div class='atwho-view'><ul class='atwho-view-ul'></ul><a href="https://slashcommand.club" target="_blank"><img src='${require("icons/command.png")}' class='atwho-view-icon' /></a></div>`);
